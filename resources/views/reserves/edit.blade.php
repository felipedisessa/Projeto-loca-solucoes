<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:p-8 mt-8 bg-slate-800">
        <form action="{{ route('reserves.update', $reserve->id) }}" method="post" class="max-w-7xl mx-auto">
            @csrf
            @method('patch')
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="title" id="title" value="{{ $reserve->title }}"
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="datetime-local" name="start" id="start" value="{{ \Carbon\Carbon::parse($reserve->start)->format('Y-m-d\TH:i') }}"
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="datetime-local" name="end" id="end" value="{{ \Carbon\Carbon::parse($reserve->end)->format('Y-m-d\TH:i') }}"
                               class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="price" id="price" value="{{ $reserve->price }}"
                               class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                               placeholder=" "/>
                        <label for="price"
                               class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                ...
                <div class="w-full md:w-1/2 px-3">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="payment_type" id="payment_type" value="{{ $reserve->payment_type }}"
                               class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                               placeholder=" "/>
