            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                    <form method="GET" action="{{ route('reports.index') }}"
                          class="print:hidden bg-white dark:bg-gray-700 p-6 shadow-md rounded-lg space-y-6">
                    ...
                    @else
                        <div
                            class="relative overflow-x-auto shadow-md sm:rounded-lg p-8 bg-gray-100 dark:bg-gray-700 mt-6">
                            <p class="text-gray-500 dark:text-gray-400">Selecione um periodo válido para gerar o
                                relatório</p>
                        </div>
                    @endif
                </div>
