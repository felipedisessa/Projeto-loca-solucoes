            ...
            <form id="create-rental-item-form" action="{{ route('rental-items.store') }}" method="post" class="p-4 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                   ...
                   <div id="name-error" class="text-red-600"></div>
                    ...
                    <div class="md:col-span-2">
                        <label for="rental_item_notes" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Observações</label>
                        <input type="text" name="rental_item_notes" id="rental_item_notes" value="{{ old('rental_item_notes') }}" class="block w-full p-2.5 text-sm bg-gray-50 border border-gray-300 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white"/>
                    </div>
